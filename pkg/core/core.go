	...
	mux.engine.Use(func(ctx *gin.Context) {
		...
		defer func() {
			...
			traceHeader := map[string]string{
				...
				configs.Get().SkyCloud.HeaderLoginToken:    ctx.GetHeader(configs.Get().SkyCloud.HeaderLoginToken),
				configs.Get().SkyCloud.HeaderSignToken:     ctx.GetHeader(configs.Get().SkyCloud.HeaderSignToken),
				configs.Get().SkyCloud.HeaderSignTokenDate: ctx.GetHeader(configs.Get().SkyCloud.HeaderSignTokenDate),
			}
